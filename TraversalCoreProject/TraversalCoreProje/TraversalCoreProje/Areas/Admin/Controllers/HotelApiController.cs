                ...
                Headers =
    {
        ...
        { "X-RapidAPI-Host", "booking-com.p.rapidapi.com" },
            ...
            using (var response = await client.SendAsync(request))
            {
                ...
                var bodyReplace = body.Replace(".", "");//. olan yerleri boş bırakır
                var listHotels = JsonConvert.DeserializeObject<HotelApiViewModel>(bodyReplace);
                return View(listHotels.result);
            }
        }
